...
We provides the 'vcd2df' function, which loads a IEEE 1364-1995/2001
VCD (.vcd) file, specified as a parameter of string type containing exactly
...
renamed this file to document it's source design, and store it locally
